  ...
  return (
    <S.ContainerMain>
      ...
      <S.P>
        ...
        prints the string {'"(null)"'} to file descriptor 1 (usually, the
        terminal or stdout) and returns 6, which is the number of characters in{' '}
        {'"(null)"'}. This step ensures that the function gracefully handles
      ...
      <S.P>
        ...
        that continues until the current character of the string ( indicated by
        s[ i ] ) is the null character \0, which marks the end of a string in C. In
      ...
      <S.P>
        ...
        uses the write function to print the string s to file descriptor 1. It
        passes i as the number of bytes to write, ensuring that only the
        characters of the string (excluding the final null character)  are
        printed.
      </S.P>
      <S.P>
        ° <S.Gold>Return: Finally :</S.Gold>, the function returns i, the number of characters in
        the string (not including the final null character). This allows calls
      ...
      <S.P>
        ...
        handling null strings by printing {'"(null)"'} in those cases.
      </S.P>
      <br />
      <Footer />
    </S.ContainerMain>
